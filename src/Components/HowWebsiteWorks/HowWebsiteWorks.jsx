...
const HowWebsiteWorks = () => {
  return (
    <div>
       <h3 className="lg:mt-36 mt-[10vh] md:mt-[15vh] spacing text-center 2xl:text-4xl mb-[3%] font-semibold text-xl"> How Website <span className='text-[#f42a41]'>Works</span></h3>
       {/* <p className=" bg-[#f42a41] mb-[3%] h-1 mt-[1vh] mx-auto w-[70%] md:w-[40%] lg:w-[23%]"></p> */}
       {/* <p className=" bg-[#f42a41] mb-[5%] h-1 mt-[1%] mx-auto w-[23%]"></p> */}
       {/* main div */}
       ...
       <p className="rounded-[50%] mb-[10%] w-max mx-auto px-4 py-2 drop-shadow-xl shadow-xl shadow-black bg-[#f42a41] text-white font-medium ">1</p>
    
         <h3 className="spacing text-center 2xl:text-2xl font-bold text-xl">Login && Find Bio</h3>
         <p className=" bg-[#f42a41] mb-[5%]  h-1 mt-[1vh] mx-auto w-[30%]"></p>
        ...
        {/* one */}
       <div className="spacing text-center 2xl:text-lg">
       <p className="rounded-[50%] mb-[10%] w-max mx-auto px-4 py-2 drop-shadow-xl shadow-xl shadow-black bg-[#f42a41] text-white font-medium ">2</p>
        ...
        {/* one */}
       <div className="spacing text-center 2xl:text-lg ">
       <p className="rounded-[50%] mb-[10%] w-max mx-auto px-4 py-2 drop-shadow-xl shadow-xl shadow-black bg-[#f42a41] text-white font-medium ">3</p>
