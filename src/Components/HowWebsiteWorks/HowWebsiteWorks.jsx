...
const HowWebsiteWorks = () => {
  return (
    <div>
       <h3 className="lg:mt-36 mt-[10vh] md:mt-[15vh] spacing text-center 2xl:text-3xl font-bold text-xl"> How Website Works</h3>
       <p className=" bg-[#f06598] mb-[3%] h-1 mt-[1vh] mx-auto w-[70%] md:w-[40%] lg:w-[23%]"></p>
