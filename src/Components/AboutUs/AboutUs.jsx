...
const AboutUs = () => {
    return (
        ...
        <div className="space-y-6 drop-shadow-xl pb-[5%] shadow-xl shadow-black md:space-y-0 flex flex-col justify-center items-center md:gap-6 lg:items-center lg:gap-12">
      ...
      <div className="container m-auto px-6  text-gray-600 md:px-12 xl:px-6">
        <div className="space-y-6 drop-shadow-xl pb-[5%] shadow-xl shadow-black md:space-y-0 flex flex-col justify-center items-center md:gap-6 lg:items-center lg:gap-12">
          <div className="md:w-5/12 lg:w-5/12">
            <img
              src="https://thumbs.dreamstime.com/b/male-female-characters-hugging-landing-page-template-loving-couple-romantic-relations-man-woman-embrace-each-other-happy-218903491.jpg"
              alt="image"
              loading="lazy"
              width=""
              height=""
