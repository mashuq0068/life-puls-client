...
const Banner = () => {
    ...
    return (
        <div className="bg-[#fda3c4] flex justify-center  h-[120vh] w-full">
           ...
           <div className="absolute lg:block hidden  uppercase font-bold  rotate-90 left-[1%] top-[50%]  2xl:text-4xl lg:text-2xl spacing ">
            <p>Best Platform</p>
           </div>
          ...
          <hr  className="border border-white h-full w-full"/>
           ...
           <div className="absolute lg:block hidden -left-[5%] h-[20%] w-[40%] rotate-90">
